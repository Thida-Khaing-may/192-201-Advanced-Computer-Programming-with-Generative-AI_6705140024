...
| - | ------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------ | ----------------------------------------------------------------------------------------------------------------------- |
| 1 | **"Why does the original code use `it[0]` and `it[1]` for the order items?"**                                       | Explained that each order item in the legacy code is a tuple where `it[0]` is the product index and `it[1]` is the quantity.                                               | Accepted                 | I checked the original `ORDERS` data and confirmed what each tuple value represented.                                   |
